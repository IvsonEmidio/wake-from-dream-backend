...
describe("Test whether a new record has created on database", () => {
  test("should create a new report on database", async () => {
    ...
    let testingData: IReportPostParameters = {
      ...
      events: ["tunnel_vision", "need_finish_mission"],
    };
...
describe("Test whether a user can update the report correctly", () => {
  test("Should update the report correctly", async () => {
    ...
    let response = await service.updateSingleReport(data);
